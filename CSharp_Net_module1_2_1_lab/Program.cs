...
namespace CSharp_Net_module1_2_1_lab
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("user2.BooksCount "+user2.BooksCount());
            Console.WriteLine("user2 :");
            Console.WriteLine("Add Sherlock Holmes2");
            user2.AddBook("Sherlock Holmes2");
            Console.WriteLine("Remove Harry Potter");
            user1.RemoveBook("Harry Potter");
            Console.WriteLine("User 1: add Harry Potter23");
            user1.AddBook("Harry Potter23");
            Console.WriteLine("User 1: add Harry");
            user1.AddBook("Harry");
